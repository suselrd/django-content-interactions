...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'content_interactions_comment', (
            ...
            ('answer_to', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='answers', null=True, to=orm['content_interactions.Comment'])),
        ...
        db.send_create_signal(u'content_interactions', ['Comment'])


    def backwards(self, orm):
        # Deleting model 'Comment'
        db.delete_table(u'content_interactions_comment')
    ...
    models = {
        ...
        u'content_interactions.comment': {
            'Meta': {'ordering': "('submit_date',)", 'object_name': 'Comment'},
            'answer_to': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'answers'", 'null': 'True', 'to': u"orm['content_interactions.Comment']"}),
    ...
    complete_apps = ['content_interactions']